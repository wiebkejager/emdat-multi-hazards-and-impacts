...
PROCESSED_IMPACT_PATH2_CSV = (
    "C:/Users/wja209/DATA/PROCESSED/impact_hazard_exposure_vulnerability_2000_2015.csv"
)
PROCESSED_IMPACT_PATH2 = (
    "C:/Users/wja209/DATA/PROCESSED/impact_hazard_exposure_vulnerability_2000_2015gpkg"
)
PROCESSED_IMPACT_PATH2_GEOM_CSV = "C:/Users/wja209/DATA/PROCESSED/impact_hazard_exposure_vulnerability_2000_2015_geometries.csv"
...
#     df.to_csv(HAZARD_PATH + hazard + "_2000_2015.csv", index=False)
...
for hazard in hazards:
    print(hazard)
    # Load hazard file
    df_hazard = pd.read_csv(HAZARD_PATH + hazard + "_2000_2015.csv")
