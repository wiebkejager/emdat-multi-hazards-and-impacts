...
# - Filters EMDAT to relevant records
...
PROCESSED_UNIQUE_IMPACT_PATH_CSV = (
    "data/unique_records_impact_" + str(FIRST_YEAR) + "_" + str(LAST_YEAR) + ".csv"
)

# %% Disater to hazard mappings. These are used to select the relevant records in the emdat data set
...
# %% Select records in revelant time period
# Fill missing day values with 1 to enable date conversion when month and year are present. Relevant for droughts and extreme temperature records who are mostly recorded as months &year
...
# %% Define Hazard1 and select records with relevant Hazard1
...
# %% Define Hazard2 and select records with relevant Hazard2
...
# %% Define Hazard3 and select records with relevant Hazard3
...
# %%
# Aggregate to 1 geometry per disaster record
